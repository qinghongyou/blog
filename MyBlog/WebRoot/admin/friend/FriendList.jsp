                ...
                <td align="center" valign="top">
                	<table border="0" width="540" cellspacing="0" cellpadding="0" rules="none">
						...
						<tr height="35">
							...
							<td align="center"><a href="FriendServlet?action=modify&id=<%=single.getId() %>" class="word_purple ">√修改</a></td>
							<td align="center"><a href="FriendServlet?action=delete&id=<%=single.getId() %>" class="word_purple ">×删除</a></td>							
						</tr>
						<%
    							}
							}
