                ...
                <td width="598" align="center" valign="top">
                	<table border="0" width="95%" cellspacing="0" style="margin-top:10" >
                        ...
                        <tr height="30">
                           	...
                           	<td align="center" width="15%"><a href="PhotoServlet?action=single&id=<%=single.getId()%>" target="_blank">查看照片</a></td>
                           	<td align="center" width="10%"><a href="PhotoServlet?action=delete&id=<%=single.getId()%>">×删除</a></td>
                        </tr>
                        <%                        			
                        		}                  				
                        	}
