...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr height="29"><td background="images/left_T.jpg" style="text-indent:45;padding-top:8"><b><font color="white">博主信息</font></b></td></tr>
                    <tr height="40">
                    ...
                    <tr height="40">
                    	<td background="images/left_M.jpg" style="text-indent:30">博主性别：<%=((MasterBean)session.getAttribute("master")).getMasterSex()%></td>
                    </tr> 
                    <tr height="40">
                    	<td background="images/left_M.jpg" style="text-indent:30">QQ号码：<%=((MasterBean)session.getAttribute("master")).getMasterOicq()%></td>
                    </tr>                    
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr height="29"><td background="images/left_T.jpg" style="text-indent:45;padding-top:8"><b><font color="white">最新留言</font></b></td></tr>
                    <%
        ...
        <tr>
            <td valign="top">
                <table width="100%" height="60" border="0" cellspacing="0" cellpadding="0">
                    <tr height="29"><td background="images/left_T.jpg" style="text-indent:45;padding-top:8"><b><font color="white">博主推荐</font></b></td></tr>
                    <%
        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr height="29"><td background="images/left_T.jpg" style="text-indent:45;padding-top:8"><b><font color="white">好友博客</font></b></td></tr>
                    <%
